        ...
        <form action="{{ url('sellrequest') }}" method="POST">
            ...
            <section class="select-payee">
                ...
                <div class="sell-amt-box">
                    <p>Sell amount</p>
                    <div class="amnt-detail" style=" border: 1px solid #fff;border-radius: 8px;  padding: 0 10px;">
                        <input type="number" id="amount" name="amount" placeholder="Please enter the amount" class="sell-amt">
                        <p>USDT</p>
                    </div>
                    ...
                    <div class="sell-table">
                        <table class="table table-bordered">
                            @if(isset($category))
                            <tbody>
                                <input type="hidden" id="categoryType" name="category" value={{$category->price}}>
                                <tr>
                                    <td>{{ $category->name }}</td>
                                    <td>
                                        <label id="changeButton" class="btn btn-success" onclick="setCategoryType('{{ $category->type }}')">
                                            {{$category->price}}+ <span class="red-text"></span>
                                        </label>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2">Please Select Category</td>
                                </tr>
                            </tbody>
                            @endif
                        </table>
            ...
            <div class="set-password-box confrm-trans-box">
                <div class="transaction-head">
                    ...
                    <p>Exchange for</p>
                    <h6><strong>10 ~ ₹ {{$category->price}} </strong></h6>
                </div>
