...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{url('favicon/favicon1.png')}}">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link rel="stylesheet" href="{{url('css/common.css?v=2.2.1')}}">
    <link rel="stylesheet" href="{{url('css/custom.css?v=2.2.1')}}">
...
<main class="contain-width">
        ...
        <a href="{{url('dashboard')}}" class="welcome-main">
         ...
         <!-- <div class="welcome-main"><img src="../wolfx-ui/assets/images/light-logo.png" alt="light-logo" class="img-fluid"></div> -->

         <div class="welcome-info">
            <h5>Welcome to WolfX Register</h5>
            <p>WolfX is the most trustable and exchange partner, the more you exchange, the more you earn!!</p>

            <!-- <button class="auth-btn">Login</button> -->
            {{-- <form action="login-userid" method="POST" class="w-100"> --}}
                <a class="auth-btn" href="{{url('login')}}"><input class="auth-btn" type="submit" value="Login" /></a>
            {{-- </form> --}}
            <div class="register-query">Already you don't have Account? <a href="{{url('register')}}">sign up</a></div>
         </div>
        </section>
    </main>
