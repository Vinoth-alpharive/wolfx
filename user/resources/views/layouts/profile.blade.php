        ...
        <section class="p-0">
            <div class="total-process">
                <div class="inner-process">
                    <div>
                        <p>Total amount($)</p>
                        <h2>{{$wallet->balance + $wallet->escrow_balance}}</h2>
                    </div>
                ...
                <button class="payx" data-bs-toggle="modal" data-bs-target="#payxModal">
                    <div class="wx-top">
                        <div class="left-part">
                            ...
                            <div>
                                <h2>0 PAYX</h2>
                                <p>1WOLX = 0010851 USDT <img src="{{url('image/query.svg')}}" alt="query"></p>
                            </div>
                        </div>
                        ...
                        <input class="auth-btn wolf-btn cursor"  value="To WolfX pro" />
                </button>
