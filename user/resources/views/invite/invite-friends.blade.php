    ...
    @include('layouts.header')
        ...
        <div class="set-password-box">
            <div class="transaction-head">
                ...
                <div class="set-up-img" style="outline:1px">
                    @php $refAddress = Config::get('app.url').'/referral/'.$referral->referral_id; @endphp
                    {!! QrCode::size(180)->generate($refAddress) !!}
                </div>
