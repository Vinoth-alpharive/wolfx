...
$(document).ready(function () {
	$(function () {
		...
		$('.matrixbg ul li a').each(function () {
			var $this = $(this);
...
$(".mobilegrid>li:first-child").click(function () {
	...
	$(".tradepage").removeClass("chatbgactive");
});
...
$(".mobilegrid>li:nth-child(3)").click(function () {
	...
	$(".tradepage").addClass("chatbgactive");
});
...
$(document).ready(function() {
    ...
    $('.button-psswd').on('click', function() {     
      if ($('.input-psswd').attr('psswd-shown') == 'false') {
        ...
        $('.button-psswd').html('<i class="fa fa-eye-slash" aria-hidden="true" title="Hide Password"></i>');
        ...
        $('.button-psswd').html('<i class="fa fa-eye" aria-hidden="true" title="Show Password"></i>');
        
      }
      
    });

    $('.button-psswd1').on('click', function() {     
      if ($('.input-psswd1').attr('psswd-shown') == 'false') {
        
        $('.input-psswd1').removeAttr('type');
        $('.input-psswd1').attr('type', 'text');
        
        $('.input-psswd1').removeAttr('psswd-shown');
        $('.input-psswd1').attr('psswd-shown', 'true');
        
        $('.button-psswd1').html('<i class="fa fa-eye-slash" aria-hidden="true" title="Hide Password"></i>');
        
        }else {        
          $('.input-psswd1').removeAttr('type');
          $('.input-psswd1').attr('type', 'password');
          
          $('.input-psswd1').removeAttr('psswd-shown');
          $('.input-psswd1').attr('psswd-shown', 'false');
          
          $('.button-psswd1').html('<i class="fa fa-eye" aria-hidden="true" title="Show Password"></i>');        
      }
