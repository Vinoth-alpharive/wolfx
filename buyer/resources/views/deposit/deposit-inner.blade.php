...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/common.css?v=2.2.9')}}">
<link rel="stylesheet" href="{{url('css/style.css?v=2.2.9')}}">
<link rel="stylesheet" href="{{url('css/custom.css?v=2.2.9')}}">
<link rel="stylesheet" href="{{url('css/user_new.css?v=2.2.9')}}">
<link rel="stylesheet" href="{{url('css/media.css?v=2.2.9')}}">
            ...
            <div class="withdraw-direct">
                ...
                <div class="support-part">
                    <!-- <div class="note-link">
                        ...
                        <a class="btn" data-bs-toggle="modal" href="#exampleModalToggle2" role="button"><i class="fa-solid fa-circle-exclamation"></i></a>
                    </div> -->
