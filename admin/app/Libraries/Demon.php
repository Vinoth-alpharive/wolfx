...
class Demon
{
	...
	public function __construct($username, $psw, $ip, $demonport)
	{
	...
	{
		return $this->bitcoin->getblockchaininfo();
	}
	...
	public function getaddressesbyaccount(){
		return $this->bitcoin->getaddressesbyaccount();
	}
