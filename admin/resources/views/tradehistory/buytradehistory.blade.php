...
<section class="content">
	...
	<div class="card">
		<div class="card-body">
			<form action="{{url('admin/buy_tradehistory')}}" method="GET">
				@csrf
			<div class="row">
				...
				<div class="col-md-5 tg-select">
                    ...
                    @if(isset($pairs))
                        {{-- <option value="{{ url('admin/buy_tradehistory/'.$tradepair->coinone.'_'.$tradepair->cointwo.'/'.$type) }}">{{ $tradepair->coinone }} / {{ $tradepair->cointwo }}</option> --}}
