            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ url('admin/updatelaunchpad') }}" autocomplete="off"
                                        ...
                                        <select name="symbol" id="coin_type" class="form-control">
                                            ...
                                            @foreach ($coins as $coin)
                                                <option value="{{ $coin->source }}"
                                                    {{ $coin->source == $pad->symbol ? 'selected' : '' }}>
                                                    {{ $coin->source }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <select name="cointwo" id="coin_type" class="form-control">
                                            ...
                                            @foreach ($coins as $coin)
                                                <option value="{{ $coin->source }}"
                                                    {{ $coin->source == $pad->cointwo ? 'selected' : '' }}>
                                                    {{ $coin->source }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="website" class="form-control"
                                            value="{{ $pad->website }}" /><i class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group" {{ $errors->has('protocol_network') ? ' has-error' : '' }}>
                                        ...
                                        <select name="protocol_network" id="coin_type" class="form-control">
                                            ...
                                            <option value="BEP20"
                                                {{ $pad->protocol_network == 'BEP20' ? 'selected' : '' }}>BEP20 Token
                                            </option>
                                            <option value="TRC20"
                                                {{ $pad->protocol_network == 'TRC20' ? 'selected' : '' }}>TRC20 Token
                                            </option>
                                            <option value="ERC20"
                                                {{ $pad->protocol_network == 'ERC20' ? 'selected' : '' }}>ERC20 Token
                                            </option>
                                            <option value="POLY20"
                                                {{ $pad->protocol_network == 'POLY20' ? 'selected' : '' }}>POLY20 Token
                                            </option>
                                            <option value="ERC20"
                                                {{ $pad->protocol_network == 'ERC20' ? 'selected' : '' }}>ERC20 Token
                                            </option>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="industry" class="form-control"
                                            value="{{ $pad->industry }}" /><i class="form-group__bar"></i>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <textarea name="description" class="form-control" value="">{{ $pad->description }}</textarea><i class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="supply_per_session" class="form-control"
                                            value="{{ $pad->supply_per_session }}" /><i class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="price_in_cointwo" step="any"
                                            class="form-control" value="{{ $pad->price_in_cointwo }}" /><i
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="min_token_purchase" step="any"
                                            class="form-control" value="{{ $pad->min_token_purchase }}" /><i
                                            class="form-group__bar"></i>
                            ...
                            {{-- <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="min_fiat_purchase" class="form-control"
                                            value="{{ $pad->min_fiat_purchase }}" /><i class="form-group__bar"></i>
                                        @if ($errors->has('min_fiat_purchase'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('min_fiat_purchase') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="stage" class="form-control"
                                            value="{{ $pad->stage }}" /><i class="form-group__bar"></i>
                                        @if ($errors->has('stage'))
                                            <span class="help-block">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="discount" step="any" class="form-control"
                                            value="{{ $pad->discount }}" /><i class="form-group__bar"></i>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="roi" step="any" class="form-control"
                                            value="{{ $pad->roi }}" /><i class="form-group__bar"></i>
                                        @if ($errors->has('roi'))
                                            <span class="help-block">
                                    ...
                                    <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
                                        <div class="form-group  has-feedback">
                                            <div class="col-xs-12 inputGroupContainer">
                                                <img src="{{ \Config::get('app.siteurl') }}/images/color/{{ $pad->logo }}"
                                                    id="doc1" width="36px" height="36px"
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    ...
                                    <div class="form-group{{ $errors->has('banner') ? ' has-error' : '' }}">
                                        <div class="form-group  has-feedback">
                                            <div class="col-xs-12 inputGroupContainer"> <img
                                                    src="{{ \Config::get('app.siteurl') }}/images/color/{{ $pad->banner }}"
                                                    id="doc2" width="36px" height="36px"
                                                    class="img-responsive kyc_img_cls" />
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    ...
                                    <div class="form-group{{ $errors->has('whitepaper') ? ' has-error' : '' }}">
                                        <div class="form-group  has-feedback">
                                            <div class="col-xs-12 inputGroupContainer"><a
                                                    href="{{ \Config::get('app.siteurl') }}/images/color/{{ $pad->whitepaper }}"
                                                    target="_blank"> {{ $pad->whitepaper }}</a><br>
                                                <div class="file-wrapper file">
                                                    <input type="file" name="whitepaper" accept="application/pdf" />
                                                    <div class="close-btn pdf">×</div>
                                                    <label for="file-upload3" class="">
                                                        <i class="fa fa-cloud-upload"></i> Upload whitepaper </label>
                                                    ...
                                                    @if ($errors->has('whitepaper'))
                                                        <span class="help-block">
                                                            <strong>{{ $errors->first('whitepaper') }}</strong>
                                                        </span><br />
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    ...
                                    <div class="form-group{{ $errors->has('presentation') ? ' has-error' : '' }}">
                                        <div class="form-group  has-feedback">
                                            <div class="col-xs-12 inputGroupContainer"><a
                                                    href="{{ \Config::get('app.siteurl') }}/images/color/{{ $pad->presentation }}"
                                                    target="_blank"> {{ $pad->presentation }}</a><br>
                                                <div class="file-wrapper file">
                                                    <input type="file" name="presentation" accept="application/pdf" />
                                                    <div class="close-btn pdf">×</div>
                                                    <label for="file-upload4" class=""> <i
                                                            class="fa fa-cloud-upload"></i> Upload presentation
                                                    </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="datetime-local" name="start_date" class="form-control"
                                            value="{{ \Carbon\Carbon::parse($pad->start_date)->format('Y-m-d H:i:s') }}" /><i
                                            class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="datetime-local" name="end_date" class="form-control"
                                            value="{{ \Carbon\Carbon::parse($pad->end_date)->format('Y-m-d H:i:s') }}" /><i
                                            class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="referral_commission" class="form-control"
                                            value="{{ $pad->referral_commission }}" /><i class="form-group__bar"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <select name="referral_coin_type" id="referral_coin_type" class="form-control">
                                            ...
                                            @foreach ($coins as $coin)
                                                <option value="{{ $coin->source }}"
                                                    {{ $pad->referral_coin_type == $coin->source ? 'selected' : '' }}>
                                                    {{ $coin->source }}
                                                </option>
                                            @endforeach
                                        </select>
