        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive">
                <a href="{{ url('/admin/newoffer') }}" class="btn btn-info">Add Reward</a>
                @if (session('status'))
              ...
              <table class="table">
                ...
                @forelse($rewards as $key => $reward)
                  <tr>
                    ...
                    <td><a href="{{ url('/admin/viewoffer', Crypt::encrypt($reward->id)) }}" class="btn btn-info">View / Edit</a>
                    <a href="{{ url('/admin/deleteoffer', Crypt::encrypt($reward->id)) }}" class="btn btn-info">Delete</a> 
