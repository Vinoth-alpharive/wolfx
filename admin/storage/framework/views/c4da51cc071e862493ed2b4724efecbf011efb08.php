                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($trade->account_number); ?></td>
                                    <td><a href="<?php echo e(url('admin/view-purchase-completed')); ?>/<?php echo e(Crypt::encrypt($trade->id)); ?>" class="btn btn-info">View</a></td>
                                ...
                                <tr>
                                    <td colspan="12">
                                        <div class="alert alert-info">Yet no Purchase Request available</div>
                                    </td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WolfX_admin\public\resources\views/purchase/purchasehistory.blade.php ENDPATH**/ ?>