...
<footer class="footer hidden-xs-down">
  <?php $updateyear = date('Y') ?>
  <p>Copyright © <?php echo e($updateyear); ?> Wolfx. All rights reserved.</p>
</footer>
</section>
</main>
...
var type = $('#coin_type :selected').val();
 ...
 if(type == 'token' || type == 'erctoken'|| type == 'trxtoken' || type == 'bsctoken'|| type == 'polytoken')
  {
      $('#contract').show();
      $('#abi').show();
  }
...
</html><?php /**PATH C:\xampp\htdocs\WolfX_admin\public\resources\views/layouts/footer.blade.php ENDPATH**/ ?>