...
{
      background: url('<?php echo e(url('/images/404banner.jpg')); ?>');
	...
	<div class="container">
		<div class="col-md-8">	
		  ...
		  <div class="sitelogo">
			...
			<img src="<?php echo e(url('/images/404.png')); ?>" class="img-responsive own-img" />
				<h1 class="t-gray">Page Not Found.</h1>
			<h4 class="title-w pt-10">Please try one of the following pages </h4>
			<div class="btn-bg">
			<a href="<?php echo e(url('/')); ?>">Go To Exchange</a>
			</div>				
			</div>		
		</div>
	</div>		
</body>
</html><?php /**PATH C:\xampp\htdocs\WolfX_admin\public\resources\views/errors/404.blade.php ENDPATH**/ ?>